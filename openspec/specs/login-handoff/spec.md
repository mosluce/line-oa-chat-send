# login-handoff Specification

## Purpose

Arming, verifying, timing, and revoking a temporary externally reachable interactive login session that attaches to an existing browser session.
