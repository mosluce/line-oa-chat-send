...
What SKILL.md and its reference material must contain, what must live outside it, and the consistency rules between documentation and the scripts it describes.
